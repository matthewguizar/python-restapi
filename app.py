...
def create_app(db_url=None):
    ...
    app.config["JWT_SECRET_KEY"] = "48669604392406662350628650014154567074195420191948495665665991822610771692930"
    jwt = JWTManager(app)
    ...
    def invalid_token_loader(error):
        return(
            jsonify({"message": "signature verification has failed", "error": "invalid_token"}),
            401,
        )
